...
const Subscriptions = () => {
  ...
  const fetchSubs = async (
    ...
    try {
      ...
      return {
        ...
        currentPage:
          typeof meta.current_page === "number" ? meta.current_page : pageNum,
  ...
  useEffect(() => {
    ...
    fetchSubs(page, pageSize, filter).then(
      ({ subsList, total, totalPages, currentPage, pageSize }) => {
            ...
            {subs.length === 0 ? (
              ...
              subs.map((sub, idx) => (
                ...
                >
                  ...
                  <td style={tdStyle}>
                    {sub.user_detail && sub.user_detail.name
                      ? sub.user_detail.name
                      : "-"}
                  </td>
                  <td style={tdStyle}>
                    {sub.plan_detail && sub.plan_detail.name
