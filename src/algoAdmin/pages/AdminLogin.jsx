  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success === true) {
        ...
        Cookies.set("adminAccessToken", response.data.access, { expires: 1 }); // Expires in 1 day
  ...
  return (
    <div className="adminlogin-root">
      <div className="adminlogin-container">
        <div>
          <h2 className="adminlogin-title">Welcome Back</h2>
          <p className="adminlogin-subtitle">Please sign in to your account</p>
